...
<link href="<?php echo $this->_var['ectouch_themes']; ?>/ectouch.css?id=11212" rel="stylesheet" type="text/css" />
...
<dl class="user_top">
  ...
  <div class="user_distri_list">
    <ul>
      <li> 累计销售：￥<?php if ($this->_var['tianxin100all']['order_amount']): ?><?php echo $this->_var['tianxin100all']['order_amount']; ?><?php else: ?>0<?php endif; ?></li>
      <li> 累计佣金：￥<?php if ($this->_var['tianxin100all']['setmoney']): ?><?php echo $this->_var['tianxin100all']['setmoney']; ?><?php else: ?>0<?php endif; ?></li>
    </ul>
  </div>
  <div class="quan1"></div>
  <div class="quan2"></div>
...
?>
      ...
      <li><span class="uninclude">&nbsp; &nbsp; </span><span>我的推广</span></li>
        ...
        -->
      <li><span class="uninclude">&nbsp; &nbsp; </span><span>我的佣金</span> <span class="person"><?php echo $this->_var['tianxin100all']['setmoney']; ?></span></li>
        <div class="son_list">
          <ul>
            <li><span class="icon2">&nbsp; &nbsp; </span><span>未付款订单佣金</span> <span class="sp">￥<?php if ($this->_var['tianxin100arr']['weifukuan']['setmoney']): ?><?php echo $this->_var['tianxin100arr']['weifukuan']['setmoney']; ?><?php else: ?>0<?php endif; ?></span></li>
            <li><span class="icon2">&nbsp; &nbsp; </span><span>已付款订单佣金</span> <span class="sp">￥<?php if ($this->_var['tianxin100arr']['yifukuan']['setmoney']): ?><?php echo $this->_var['tianxin100arr']['yifukuan']['setmoney']; ?><?php else: ?>0<?php endif; ?></span></li>
            <li><span class="icon2">&nbsp; &nbsp; </span><span>已收货订单佣金</span> <span class="sp">￥<?php if ($this->_var['tianxin100arr']['yishouhuo']['setmoney']): ?><?php echo $this->_var['tianxin100arr']['yishouhuo']['setmoney']; ?><?php else: ?>0<?php endif; ?></span></li>
			<li><span class="icon2">&nbsp; &nbsp; </span><span>可提现余额</span> <span class="sp"><?php echo $this->_var['info']['surplus']; ?></span></li>
			<!--
