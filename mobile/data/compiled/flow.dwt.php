...
<link href="<?php echo $this->_var['ectouch_themes']; ?>/ectouch.css?id=112" rel="stylesheet" type="text/css" />
    ...
    <section class="order_box padd1 radius10 goodsBuy "> 
      <table class="ectouch_table" width="100%" border="0" cellspacing="0" cellpadding="5">
        ...
        <tr>
          ...
          <td bgcolor="#ffffff" align="left"> <?php echo $this->_var['lang']['far_ext']['\$favourable']['act_range']; ?><br />
